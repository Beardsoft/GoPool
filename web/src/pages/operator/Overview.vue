...
@media (max-width: 900px) { .metrics { grid-template-columns: 1fr 1fr; }.metrics article:nth-child(2) { border-right: 0; }.metrics article:nth-child(-n+2) { border-bottom: 1px solid var(--app-border); }.detail-grid { grid-template-columns: 1fr; }.activity-section li { grid-template-columns: 9px minmax(0, 1fr); }.activity-section .event-facts { grid-column: 2; justify-content: flex-start; } }
